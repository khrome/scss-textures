...
return Object.defineProperty(s,"__esModule",{value:!0}),s}catch(a){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("scss-textures-website/app").default.create({name:"scss-textures-website",version:"0.0.0+5a414432"})
